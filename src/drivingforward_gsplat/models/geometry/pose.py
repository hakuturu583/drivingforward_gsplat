...
class Pose:
    ...
    def compute_pose(self, net, inputs):
        ...
        pose = self.distribute_pose(
            pose, inputs["extrinsics"], inputs["extrinsics_inv"]
        )
    ...
    def get_single_pose(self, net, inputs, cam):
        ...
        for f_i in self.frame_ids[1:]:
            ...
            output[("cam_T_cam", 0, f_i)] = vec_to_matrix(
        ...
        if self.spatio_temporal:
            ...
            for frame_id in self.frame_ids[1:]:
                for cur_index in self.rel_cam_list[cam]:
                    ...
                    rel_pose_dict[(frame_id, cur_index)] = torch.matmul(
                        rel_ext, T
                    )  # using matmul speed up
